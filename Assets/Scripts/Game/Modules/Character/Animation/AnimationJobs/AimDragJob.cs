...
public struct AimDragJob : IAnimationJob
{
    ...
    public Settings settings;
    public RepPlayerComponentData animState;
    ...
    public void Update(Vector3 target, Settings settings, RepPlayerComponentData animationState, AnimationScriptPlayable playable)
    {
