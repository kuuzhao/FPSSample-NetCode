...
public struct RepBarrelSnapshotData : ISnapshotData<RepBarrelSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref RepBarrelSnapshotData baseline1, ref RepBarrelSnapshotData baseline2)
    {
    ...
    public void Serialize(ref RepBarrelSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref RepBarrelSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
    ...
    public void Interpolate(ref RepBarrelSnapshotData target, float factor)
    {
